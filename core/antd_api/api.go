...
import (
	...
	"github.com/xuanlingzi/go-admin-core/core/api"
	"github.com/xuanlingzi/go-admin-core/core/pkg"
	"github.com/xuanlingzi/go-admin-core/core/pkg/response/antd"
	"github.com/xuanlingzi/go-admin-core/core/service"
...
func (e *Api) MakeService(c *service.Service) *Api {
	...
	c.Log = e.Logger
	c.Orm = e.Orm
	c.Cache = core.Runtime.GetCacheAdapter()
	e.Cache = c.Cache
	return e
}
